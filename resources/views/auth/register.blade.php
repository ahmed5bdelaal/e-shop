...
<form class="row" action="{{ route('register') }}" method="post">
    ...
    <div class="social-login">
        <div class="row">
        <div class="col-lg-4 col-md-4 col-12"><a class="btn facebook-btn" href="{{ url('login/facebook') }}"><i class="lni lni-facebook-filled"></i> Facebook</a></div>
        <div class="col-lg-4 col-md-4 col-12"><a class="btn github-btn" href="{{ url('login/github') }}"><i class="lni lni-github-original"></i> Github</a></div>
        <div class="col-lg-4 col-md-4 col-12"><a class="btn google-btn" href="{{ url('login/google') }}"><i class="lni lni-google"></i> Google</a>
        </div>
        </div>
        </div>
